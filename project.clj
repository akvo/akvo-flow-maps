(defproject org.akvo/flow-maps "0.1.0-SNAPSHOT"
  ...
  :jvm-opts ["-Djavax.net.debug=all" "-Djavax.net.ssl.keyStoreType=pkcs12" "-Djavax.net.ssl.keyStore=/kafka-certs/client.p12" "-Djavax.net.ssl.keyStorePassword=asdfgh"]
